...
-->
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Content -->
        <?php
            if($_GET['required_page'] == "addpost"){
           require_once("includes/layouts/add-post.php");
            }
            else if($_GET['required_page'] == "managepost"){
              require_once("includes/layouts/manage-post.php");  
            }
            ?>
